        ...
        <div class="mx-auto flex flex-col items-center py-12 sm:py-24">
            <div class="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
                <h1
                    ...
                    Culinary Creations: Where Every
                    <span class="text-orange-600 dark:text-orange-600">Dish</span>
                    Shines.
                </h1>
                <p
                    class="mt-5 sm:mt-10 lg:w-10/12 text-black-800 dark:text-gray-800 font-normal text-center text-xl">
                    A Community that Shares Recipes.
                </p>
            </div>
            <div class="flex w-11/12 md:w-8/12 xl:w-6/12">
                <div class="flex rounded-md w-full">
                    <input type="text" name="q"
                        class="w-full p-3 rounded-md rounded-r-none border-2 border-gray-400 placeholder-current dark:bg-white-500  dark:text-gray-300 "
                        placeholder="keyword" />
                    <button
  ...
  <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="border-b mb-5 flex justify-between text-sm">
        <div class=" flex items-center pb-2 pr-2  gap-10  uppercase">
            ...
            <a href="home/lawiki" class="font-semibold inline-block">Latest Recipes</a>
            <a href="home/lacate" class="font-semibold inline-block">Latest Categories</a>
        </div>
  
        <a href="home/explore">See All</a>
    </div>
            ...
            <div class="rounded overflow-hidden shadow-lg flex flex-col">
                ...
                <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                    <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                        ...
                        <span class="ml-1">pojmoijiojio</span>
                    </span>
                    ...
                    <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                        ...
                        <span class="ml-1">hiohhihiu</span>
                    </span>
                </div>
            </div>
  ...
  <section class="w-full bg-gray-100">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2024 RecipeBook, Inc. All rights reserved.
        </p>
    </div>
  </section>
</div>
